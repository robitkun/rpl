...
<body class="bg-gray-100">
    <div class="container mx-auto p-6">
        <h1 class="text-3xl text-yellow-500 font-bold mb-6">Edit Product</h1>
        <form action="{{ route('product.update', $product->id) }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            @method('PUT')
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="qty" name="qty" value="{{ $product->qty }}" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
            <div class="mb-4">
...
<<<<<<< HEAD
            ...
            <div class="flex items-center justify-between">
                <input type="submit" value="Update Product" class="bg-yellow-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
=======
